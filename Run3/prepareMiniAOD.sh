...
# AOD
# cmsDriver command
cmsDriver.py  --python_filename AOD_${fragment}_step2.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:AOD_${fragment}_step2.root --conditions 130X_mcRun3_2023_realistic_v14 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:DR_${fragment}_step1.root --era Run3_2023 --no_exec --mc -n -1
sed -i "20 a from IOMC.RandomEngine.RandomServiceHelper import RandomNumberServiceHelper\nrandSvc = RandomNumberServiceHelper(process.RandomNumberGeneratorService)\nrandSvc.populate()"  AOD_${fragment}_step2.py

# MINIAOD
# cmsDriver command
cmsDriver.py  --python_filename MINIAOD_${fragment}_step3.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:MINIAOD_${fragment}_step3.root --conditions 130X_mcRun3_2023_realistic_v14 --step PAT --geometry DB:Extended --filein file:AOD_${fragment}_step2.root --era Run3_2023 --no_exec --mc -n -1
